...
#ifndef __CO_TRACE_CLASS_H__
#define __CO_TRACE_CLASS_H__
...
protected:
private:
	CO_Trace_Class( const CO_Trace_Class &c );
	CO_Trace_Class& operator=( const CO_Trace_Class &c );

}; //CO_Trace_Class

#endif //__CO_TRACE_CLASS_H__
