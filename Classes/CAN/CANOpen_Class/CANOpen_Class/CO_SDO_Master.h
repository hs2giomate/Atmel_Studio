...
#ifndef __CO_SDO_MASTER_H__
#define __CO_SDO_MASTER_H__
...
protected:
private:
	CO_SDO_Master( const CO_SDO_Master &c );
	CO_SDO_Master& operator=( const CO_SDO_Master &c );
