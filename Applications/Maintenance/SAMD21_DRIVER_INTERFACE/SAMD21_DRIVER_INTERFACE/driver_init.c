 ...
 * Enables Timer peripheral, clocks and initializes Timer driver
 */
static void TIMER_CALENDAR_init(void)
{
...
void system_init(void)
{
	...
	// Set pin direction to output
	gpio_set_pin_direction(LEDA21, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(LEDA21, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PA22

	gpio_set_pin_level(LEDA22,
	                   // <y> Initial level
	                   // <id> pad_initial_level
	                   // <false"> Low
	                   // <true"> High
	...
	// Set pin direction to output
	gpio_set_pin_direction(LEDA22, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(LEDA22, GPIO_PIN_FUNCTION_OFF);
