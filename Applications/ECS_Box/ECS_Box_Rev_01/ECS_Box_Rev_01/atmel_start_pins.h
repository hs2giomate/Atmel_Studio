...
#define niAlcSPIFlashCs GPIO(GPIO_PORTB, 26)
...
#define iAlcTempSensSPIMiso GPIO(GPIO_PORTC, 15)
#define iAlcTempSensSPIMosi GPIO(GPIO_PORTC, 16)
#define iAlcTempSensSPISck GPIO(GPIO_PORTC, 17)
#define iAlcTempSensInt2 GPIO(GPIO_PORTC, 18)
...
#define iAlcTempSensInt0 GPIO(GPIO_PORTD, 0)
#define iAlcTempSensInt1 GPIO(GPIO_PORTD, 1)
#define iAlcSpiAMMCMosi GPIO(GPIO_PORTD, 8)
#define iAlcSpiAMMCSck GPIO(GPIO_PORTD, 9)
#define iAlcSpiAMMCMiso GPIO(GPIO_PORTD, 10)
