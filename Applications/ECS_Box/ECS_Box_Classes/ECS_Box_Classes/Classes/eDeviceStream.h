...
*/
inline bool eDeviceStream::lock(void)
	{
	return true;
	}

inline void eDeviceStream::unlock(void)
	{
	}


inline eDeviceStream& eDeviceStream::operator<<(streamMode m)
	{
	outputMode = m;
	return *this;
	}

inline eDeviceStream& eDeviceStream::operator<<(uint8_t v)
	{
	write(v);
	return *this;
	}

inline eDeviceStream& eDeviceStream::operator<<(uint16_t v)
	{
	write(v);
	return *this;
	}

inline eDeviceStream& eDeviceStream::operator<<(uint32_t v)
	{
	write(v);
	return *this;
	}

inline eDeviceStream& eDeviceStream::operator<<(unsigned int v)
	{
	write((uint32_t)v);
	return *this;
	}

inline eDeviceStream& eDeviceStream::operator<<(void* v)
	{
	writeAddr(v);
	return *this;
	}

inline eDeviceStream& eDeviceStream::operator<<(char v)
	{
	write(v);
	return *this;
	}

inline eDeviceStream& eDeviceStream::operator<<(int8_t v)
	{
	write(v);
	return *this;
	}

inline eDeviceStream& eDeviceStream::operator<<(int16_t v)
	{
	write(v);
	return *this;
	}

inline eDeviceStream& eDeviceStream::operator<<(int32_t v)
	{
	write(v);
	return *this;
	}

inline eDeviceStream& eDeviceStream::operator<<(int v)
	{
	write((int32_t)v);
	return *this;
	}

inline eDeviceStream& eDeviceStream::operator<<(float v)
	{
	write(v);
	return *this;
	}

inline eDeviceStream& eDeviceStream::operator<<(const char* v)
	{
	write(v);
	return *this;
	}
