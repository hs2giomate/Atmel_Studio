...
#define CONF_TCC0_CC4 0
#endif
#ifndef CONF_TCC0_CC5
#define CONF_TCC0_CC5 0
#endif
...
#define CONF_TCC2_CTRLA                                                                                                \
	TCC_CTRLA_PRESCALER(CONF_TCC2_PRESCALER) | (CONF_TCC2_RUNSTDBY << TCC_CTRLA_RUNSTDBY_Pos)                          \
	    ...
	    | (CONF_TCC2_CPTEN1 << TCC_CTRLA_CPTEN1_Pos) | (CONF_TCC2_CPTEN2 << TCC_CTRLA_CPTEN2_Pos)                      \
	    | (CONF_TCC2_ALOCK << TCC_CTRLA_ALOCK_Pos)
...
#define CONF_TCC2_EVCTRL                                                                                               \
	TCC_EVCTRL_CNTSEL(CONF_TCC2_CNTSEL) | (CONF_TCC2_OVFEO << TCC_EVCTRL_OVFEO_Pos)                                    \
	    ...
	    | (CONF_TCC2_MCEO2 << TCC_EVCTRL_MCEO2_Pos) | (CONF_TCC2_MCEI2 << TCC_EVCTRL_MCEI2_Pos)                        \
