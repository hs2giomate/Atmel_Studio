...
#define iAlcFwIsAlive GPIO(GPIO_PORTA, 7)
...
#define CS_TEMP2 GPIO(GPIO_PORTA, 27)
#define PB01 GPIO(GPIO_PORTB, 1)
#define CS_TEMP3 GPIO(GPIO_PORTB, 7)
...
#define CS_TEMP1 GPIO(GPIO_PORTB, 29)
#define SW0 GPIO(GPIO_PORTB, 31)
#define VBUS_DETECTED GPIO(GPIO_PORTC, 0)
#define CPU_RUNNING GPIO(GPIO_PORTC, 2)
...
#define USB_ID GPIO(GPIO_PORTC, 19)
