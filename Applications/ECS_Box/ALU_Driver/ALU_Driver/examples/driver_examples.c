...
/**
 * Example of using TIMER_CCU.
 */
struct timer_task TIMER_CCU_task1, TIMER_CCU_task2;

static void TIMER_CCU_task1_cb(const struct timer_task *const timer_task)
{
}

static void TIMER_CCU_task2_cb(const struct timer_task *const timer_task)
{
}

void TIMER_CCU_example(void)
{
	TIMER_CCU_task1.interval = 100;
	TIMER_CCU_task1.cb       = TIMER_CCU_task1_cb;
	TIMER_CCU_task1.mode     = TIMER_TASK_REPEAT;
	TIMER_CCU_task2.interval = 200;
	TIMER_CCU_task2.cb       = TIMER_CCU_task2_cb;
	TIMER_CCU_task2.mode     = TIMER_TASK_REPEAT;

	timer_add_task(&TIMER_CCU, &TIMER_CCU_task1);
	timer_add_task(&TIMER_CCU, &TIMER_CCU_task2);
	timer_start(&TIMER_CCU);
}
